...
<nav class="breadcrumb" aria-label="breadcrumbs">
    <ul>
        ...
        <li class="is-active">
            <a href="javascript:;" aria-current="page">Список людей</a>
        </li>
    </ul>
</nav>
@endsection
...
@section('info')
<div class="level">
<h1 class="title is-4 has-text-centered has-text-info level-left">Всего {{ $people->count() }} строк в БД</h1>
<span class="tag is-danger level-right"><a href="{{ route('a.i.export') }}">Скачать полный список (XLSX)</a></span>
</div>
@endsection
